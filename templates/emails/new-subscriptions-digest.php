...
<p>Here is a list of the <strong>new subscribers</strong> during the period of <?php echo $subscribers->getTimeRangeString(); ?>.</p>
...
<table>
	...
	foreach( $subscribers->getSubscribers() as $subscriber ) {
		echo '<tr>';
			...
			echo "<td>{$subscriber['date_created']}</td>";
